                ...
                <div class="col-md-8">
                    <div class="container my-5">
                        <div class="form-section">
                            ...
                            <form method="POST" action="${pageContext.request.contextPath}/GenerarPDF">
                                <!-- Campos del formulario -->
                                <div class="form-group icon-input-group">
                                    <i class="bi bi-person"></i>
                                    <input type="text" class="form-control" name="nombreCliente" id="NOMBRES_Y_APELLIDOS"
                                           placeholder="NOMBRES Y APELLIDOS" pattern="[A-Za-z\s]+" 
                                           title="Solo letras" required onkeypress="validarTexto(event)">
                                </div>
                                <div class="row mt-3">
                                    <div class="col-6">
                                        <div class="form-group icon-input-group">
                                            ...
                                            <input type="text" class="form-control" name="dni" 
                                                   placeholder="DNI" pattern="\d{8}" title="Debe contener 8 dígitos numéricos" 
                                                   required onkeypress="validarNumero(event); limitarLongitud(event, this, 8)">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group icon-input-group">
                                            ...
                                            <input type="text" class="form-control" name="celular" 
                                                   placeholder="CELULAR" pattern="\d{9}" title="Debe contener 9 dígitos numéricos" 
                                                   required onkeypress="validarNumero(event); limitarLongitud(event, this, 9)">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group icon-input-group mt-3">
                                    <i class="bi bi-geo-alt"></i>
                                    <input type="text" class="form-control" name="direccion" placeholder="DIRECCIÓN DE ENVÍO">
                                </div>
                                ...
                                <h5 class="mt-4">Tipo de Comprobante</h5>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tipoComprobante" value="boleta" id="boleta" required>
                                    <label class="form-check-label" for="boleta">Boleta</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tipoComprobante" value="factura" id="factura">
                                ...
                                <div class="submit-container mt-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <img src="ImagenesInterface/osito-removebg-preview.png" alt="Mascota" style="width: 160px; height: 160px;">
                                        <button type="submit" class="btn" 
                                                style="background-color: #e6c6e2; border-color: #e6c6e2; color: #fff;">
                                            Finalizar Compra
                                        </button>
                                    </div>
                                </div>
