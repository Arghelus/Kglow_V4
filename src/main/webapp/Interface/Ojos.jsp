...
<body>
    ...
    <section class="py-8 section-spacing">
        <div class="container-fluid"> 
            <img src="ImagenesInterface/banners/ojos.png" alt="Banner" class="banner-img" /> <!-- Imagen del banner -->
        </div>
    </section>
            ...
            <div class="col-lg-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="tipoProducto">
                        ...
                        <option value="base">Sombra</option>
                        <option value="corrector">Delineador</option>
                        <option value="rubor">Mascara para pestañas</option>
                    </select>
                </div>
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-4 g-3" id="listaProductos">
                    <%
                        ...
                        for (Producto producto : productos) {
                            ...
                            if ("3".equalsIgnoreCase(producto.getCategoria())) {
                    %>
                    <div class="col">
                        <div class="card shadow-sm h-100 d-flex flex-column">
                            <div class="overflow-hidden" style="height: 200px;">
                                <!-- Puedes ajustar la ruta de la imagen según tus necesidades -->
                                <img src="ImagenesInterface/productos/Ojos/<%= producto.getNombre_producto()%>.png" class="card-img-top img-fluid" alt="<%= producto.getNombre_producto()%>">
                            </div>
                            <div class="card-body">
